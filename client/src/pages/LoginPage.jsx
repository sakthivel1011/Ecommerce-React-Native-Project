      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium">
            Log in to your Shopping Hub account
          </p>
        </div>
        ...
        <form onSubmit={submitHandler} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-primary hover:bg-blue-600 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-lg shadow-primary/25 disabled:opacity-70 active:scale-[0.98]"
          >
